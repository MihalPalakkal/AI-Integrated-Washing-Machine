...
The User is the primary actor who initiates the laundry process by uploading garment images through the interface and receives real-time updates and washing recommendations in return.
The Intelligent Laundry System acts as the central process that receives image inputs, performs fabric analysis through the AI module, calculates the appropriate wash cycle parameters, and sends control signals to the hardware. It internally handles two key functions — fabric type detection and wash cycle calculation.
The AI System (Gemini) processes the garment images and returns detailed fabric analysis results, enabling the system to identify fabric types such as cotton, silk, or synthetic blends and determine the safest washing settings accordingly.
The Washing Machine Hardware executes the washing cycle based on the control signals received and continuously reports the cycle progress and operational status back to the system for real-time monitoring.
Together, these components define the complete operational scope of the Intelligent Laundry System, forming the foundation for the more detailed lower-level DFDs discussed in the following sections.
...
The mobile application provides users with an intuitive interface to interact with the Intelligent Laundry System. It allows users to capture garment images, review AI-generated fabric analysis, and monitor the calculated wash parameters and process. The sequence of screenshots below visualizes the primary flow and user experience of the application.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.31\textwidth]{img/app1.jpeg}\hfill
    \includegraphics[width=0.31\textwidth]{img/app2.jpeg}\hfill
    \includegraphics[width=0.31\textwidth]{img/app3.jpeg}
    \caption{Application Interface Design - Dashboard and Capture (Part 1)}
    \label{fig:app_interface_1}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.32\textwidth]{img/app4.jpeg}\hspace{1cm}
    \includegraphics[width=0.32\textwidth]{img/app5.jpeg}
    
    \vspace{0.5cm}
    
    \includegraphics[width=0.32\textwidth]{img/app6.jpeg}\hspace{1cm}
    \includegraphics[width=0.32\textwidth]{img/app7.jpeg}
    
    \caption{Application Interface Design - Analysis and Settings (Part 2)}
    \label{fig:app_interface_2}
\end{figure}
