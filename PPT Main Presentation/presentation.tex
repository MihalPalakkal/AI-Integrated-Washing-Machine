...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node at ([xshift=13.7cm, yshift=4.8cm]current page.south west)
    {\includegraphics[width=4.5cm]{img/WM_logo.png}};
...
\begin{tikzpicture}[
  box/.style={%
    ...
    font=\small\bfseries,
    minimum height=0.78cm, minimum width=2.0cm,
    align=center, inner sep=5pt},
  arr/.style={->, thick, color=AccentBlue, >=stealth, line width=1.2pt}
]
\node[box] (img)     {Cloth\\[-1pt]\scriptsize Image};
\node[box, right=0.8cm of img]     (app)     {Mobile\\[-1pt]\scriptsize App};
\node[box, right=0.8cm of app]     (gemini)  {Gemini\\[-1pt]\scriptsize API};
\node[box, right=0.8cm of gemini]  (arduino) {Arduino\\[-1pt]\scriptsize WiFi R4};
\node[box, right=0.8cm of arduino] (machine) {Washing\\[-1pt]\scriptsize Machine};
...
\centering
\includegraphics[width=0.92\textwidth, height=0.20\textheight,
...
\vspace{0.05cm}
\begin{tcolorbox}[infobar]
\centering\footnotesize\textcolor{NavyBlue}{\faLink\enspace}
