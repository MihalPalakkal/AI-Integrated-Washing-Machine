...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{10cm}|}
        \hline
        \textbf{Aspect} & \textbf{Limitation} \\
        \hline
        Fabric Identification & No existing consumer machine performs visual fabric analysis \\
        \hline
        Parameter Adaptation & Fixed cycles cannot adapt to actual soil level or fabric sensitivity \\
        \hline
        Resource Optimization & Water and detergent usage based on averages, not actual requirements \\
        \hline
        Cost & Smart machines are prohibitively expensive \\
        \hline
        Retrofit Potential & No solutions exist for upgrading existing machines \\
        \hline
        Open Architecture & Proprietary systems prevent user modification or enhancement \\
        \hline
    \end{tabular}
    \caption{Limitations of Existing Washing Machines}
    \label{tab:limitations}
\end{table}

\section{Proposed System}
The proposed AI-Integrated Washing Machine addresses the limitations of existing systems through a comprehensive retrofit solution that combines computer vision, AI-based decision making, and automated hardware control.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{10cm}|}
        \hline
        \textbf{Aspect} & \textbf{Proposed System Advantage} \\
        \hline
        Fabric Identification & Visual analysis using Gemini API for accurate material detection \\
        \hline
        Parameter Adaptation & Dynamic calculation based on actual fabric and soil level \\
        \hline
        Resource Optimization & Precise water and detergent quantities minimize waste \\
        \hline
        Cost & Retrofit approach at fraction of new smart machine cost \\
        \hline
        Retrofit Potential & Can upgrade existing semi-automatic machines \\
        \hline
        Open Architecture & Documented APIs enable customization and enhancement \\
        \hline
        Feedback Loop & Human-in-the-Loop improves accuracy over time \\
        \hline
    \end{tabular}
    \caption{Advantages of Proposed System}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{8cm}|p{4cm}|}
        \hline
        \textbf{Screen} & \textbf{Purpose} & \textbf{Interface Elements} \\
        \hline
        Dashboard & System overview and quick actions & Status indicators, quick scan button, recent cycles \\
        \hline
        Fabric Analysis & Garment scanning and results & Camera viewfinder, capture button, results display, confidence indicator \\
        \hline
        Wash Progress & Cycle monitoring & Progress bar, time remaining, stage indicator, cancel button \\
        \hline
        Manual Override & Emergency controls & Motor stop, water stop, drain now, reset \\
        \hline
        Settings & Configuration & WiFi setup, calibration values, user preferences \\
        \hline
    \end{tabular}
...
\begin{description}
    ...
    \item[FR2: Garment Scanning]
        ...
        \end{itemize}
    \item[FR3: Fabric Analysis (API 1)]
        \begin{itemize}
        ...
        \end{itemize}
    \item[FR4: Parameter Calculation (API 2)]
        \begin{itemize}
...
\hline
Detergent dispensing accuracy & ±2 ml \\
\hline
Water level accuracy & ±0.5 liters \\
\hline
